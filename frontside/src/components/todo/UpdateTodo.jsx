...
function UpdateTodo() {
    ...
    const handleSubmit = event => {
        ...
        axios.patch(`http://localhost:9292/todos/${id}`, updatedTodoData)
            .then(response => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-6 my-2 m-auto w-96 mt-8">
            <h1 className="text-2xl font-bold mb-4 text-center uppercase text-pink-300">Update Todo</h1>
            <form onSubmit={ handleSubmit } className="flex flex-col">
                <div className="mb-4">
                    <label htmlFor="name" className="block text-pink-300 font-bold mb-2">
                ...
                <div className="mb-4">
                    <label htmlFor="description" className="block text-pink-300 font-bold mb-2">
                ...
                <div className="mb-4">
                    <label htmlFor="status" className="block text-pink-300 font-bold mb-2">
                ...
                <div className="mb-4">
                    <label htmlFor="category" className="block text-pink-300 font-bold mb-2">
                ...
                <button
                    type="submit"
                    className="bg-pink-300 hover:bg-pink-400 justify-center text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center"
                >
